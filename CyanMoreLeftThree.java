...
public class CyanMoreLeftThree extends LinearOpMode {
    OpenCvCamera camera;
...
//make seperate paths if needed.
            ...
            Trajectory left4 = drive.trajectoryBuilder(new Pose2d())
                    ...
                    .build();
            Trajectory left5 = drive.trajectoryBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-5,3, Math.toRadians(107)))
                    .addTemporalMarker(.1, () -> {
                        ElevatorMotor.getCurrentPosition();
                        ElevatorMotor.setTargetPosition(140);
                        ElevatorMotor.setPower(.7);
            ...
            TrajectorySequence leftturn3 = drive.trajectorySequenceBuilder(new Pose2d())
                    .lineToLinearHeading(new Pose2d(-9,-2, Math.toRadians(-99)))
                    .addTemporalMarker(2, () -> {
                        servo.setPower(0);
                        servo1.setPower(0);

                    })
                    .splineTo(new Vector2d(-9,-2), Math.toRadians(-99))

                    .splineTo(new Vector2d(-20,0), Math.toRadians(30))
